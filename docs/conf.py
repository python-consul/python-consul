...
project = u'python-consul'
copyright = u'2014, Andy Gayton'
...
htmlhelp_basename = 'python-consuldoc'
...
latex_documents = [
  ('index', 'python-consul.tex', u'python-consul Documentation',
   u'Andy Gayton', 'manual'),
]
...
man_pages = [
    ('index', 'python-consul', u'python-consul Documentation',
     [u'Andy Gayton'], 1)
]
...
texinfo_documents = [
  ('index', 'python-consul', u'python-consul Documentation',
   u'Andy Gayton', 'python-consul', 'One line description of project.',
   'Miscellaneous'),
]
